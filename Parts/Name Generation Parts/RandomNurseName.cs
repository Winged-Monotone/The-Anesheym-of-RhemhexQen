...
{
    [Serializable]
    public class RandomNurseName : IPart
    {
        public RandomNurseName()
        {
        }
        ...
        public override bool FireEvent(Event E)
        {
            if (E.ID == "ObjectCreated")
            {
                ...
                {
                    ParentObject.DisplayName = "{{lightblue|Broodtender, }}" + RanMainName.GetRandomElement();
                }
                else
                {
                    ParentObject.DisplayName = "{{lightblue|Broodtender, }}" + RanSurName.GetRandomElement() + "'" +
                                               RanMainName.GetRandomElement();
                }
            }
