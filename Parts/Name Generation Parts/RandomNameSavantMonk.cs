...
{
    [Serializable]
    public class RandomNameSavantMonk : IPart
    {
        public RandomNameSavantMonk()
        {
        }
        ...
        public override bool FireEvent(Event E)
        {
            ...
            {
                ParentObject.DisplayName = "{{yellow|Newlight-}}" + RanMainName.GetRandomElement() +
                                           ", {{yellow|Novice Monad of the Anima}}";
            }
