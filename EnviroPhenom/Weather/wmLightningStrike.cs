...
namespace XRL.World.Parts
{
    public class wmLightningStrike : IPart
    {
        ...
        {
            var lightningChance = Stat.Random(1, 70);
        ...
        public void LightningAnimation()
        {
            ...
            NextLightning =
                new Point(
                    CurrentLightningPosition.X + (int)Math.Round(DeltaX * RandomLength, MidpointRounding.AwayFromZero),
                    CurrentLightningPosition.Y + (int)Math.Round(DeltaY * RandomLength, MidpointRounding.AwayFromZero));
            ...
            while (CurrentLightningPosition.X != TargetCell.X || CurrentLightningPosition.Y != TargetCell.Y)
            {
                ...
                LightningSegment = Zone.Line(CurrentLightningPosition.X, CurrentLightningPosition.Y, NextLightning.X,
                    NextLightning.Y);
